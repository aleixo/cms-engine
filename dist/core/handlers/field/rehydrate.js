...
const handler = ({
  ...
  var _a;
  (_a = eventReducedSchema === null || eventReducedSchema === void 0 ? void 0 : eventReducedSchema.rehydrate) === null || _a === void 0 ? void 0 : _a.forEach(config => {
...
const events = component => Object.keys(component.rehydrate || {});
